...
describe('TokenProvider', function () {
  ...
  it('isExpired', function () {
    ...
    var tp = new TokenProvider({ storage: mockLocalStorage });
    expect(tp.isExpired(new Date('Tue Jun 05 2018 15:11:58 GMT+0700 (+07)'))).toBeFalsy();
    expect(tp.isExpired(new Date('Tue Jun 05 2018 15:11:55 GMT+0700 (+07)'))).toBeTruthy();
  });
});