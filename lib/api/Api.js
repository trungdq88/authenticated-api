...
var Api = function Api(_ref) {
  ...
  this.post = function (url, body) {
    var _ref2 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : DEFAULT_OPTIONS,
        bodyPreprocessor = _ref2.bodyPreprocessor,
  ...
  this.put = function (url, body) {
    var _ref3 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : DEFAULT_OPTIONS,
        bodyPreprocessor = _ref3.bodyPreprocessor,
  ...
  this.patch = function (url, body) {
    var _ref4 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : DEFAULT_OPTIONS,
        bodyPreprocessor = _ref4.bodyPreprocessor,
  ...
  this.delete = function (url, body) {
    var _ref5 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : DEFAULT_OPTIONS,
        bodyPreprocessor = _ref5.bodyPreprocessor,
  ...
  this._sendWithRetry = function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(sendRequest) {
  ...
  this._authenticatedFetch = function () {
    var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(url, options) {
      var headers;
