...
var stripUndefinedValues = function stripUndefinedValues(source) {
...
var Api = function Api(_ref) {
  ...
  this.post = function () {
    ...
    return _this.method.apply(_this, ['POST'].concat(args));
  };
  ...
  this.put = function () {
    ...
    return _this.method.apply(_this, ['PUT'].concat(args));
  };
  ...
  this.patch = function () {
    ...
    return _this.method.apply(_this, ['PATCH'].concat(args));
  };
  ...
  this.delete = function () {
    ...
    return _this.method.apply(_this, ['DELETE'].concat(args));
  };
      ...
      return _regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              headers = stripUndefinedValues(Object.assign({
